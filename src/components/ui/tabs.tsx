			...
			{activeTab === value && (
				<AnimatePresence mode="wait">
					<motion.div
						...
						className="absolute w-full h-[4px] left-0 bottom-0 accentDarkBg rounded-lg z-[1]"
					/>
				</AnimatePresence>
			)}
					...
					{activeTab === value && (
						<AnimatePresence mode="wait">
							<motion.div
								...
								layoutId={defaultValue}
								className="absolute w-full h-[4px] left-0 bottom-0 accentDarkBg rounded-md z-[1] tab-shadow"
							/>
						</AnimatePresence>
					)}
					{activeTab === value && (
